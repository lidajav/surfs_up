...
Base = automap_base() # Reflect the database
Base.prepare(engine, reflect=True) #reflect the table

Measurement = Base.classes.measurement # Table measurement
Station = Base.classes.station # Table station
...
app = Flask(__name__) 
@app.route('/') # welcome route or our root
def welcome():
    return(
    '''
